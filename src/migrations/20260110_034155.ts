...
export async function up({ db, payload, req }: MigrateUpArgs): Promise<void> {
  ...
  CREATE TYPE "public"."enum_footer_nav_columns_menus_items_link_type" AS ENUM('reference', 'custom');
  CREATE TYPE "public"."enum_footer_nav_columns_menus_variant" AS ENUM('primary', 'secondary');
  ...
  CREATE TABLE "footer_nav_columns_menus_items" (
  	"_order" integer NOT NULL,
  	"_parent_id" varchar NOT NULL,
  	"id" varchar PRIMARY KEY NOT NULL,
  	"link_type" "enum_footer_nav_columns_menus_items_link_type" DEFAULT 'reference',
  	"link_new_tab" boolean,
  	"link_url" varchar,
  	"link_label" varchar NOT NULL
  );
  
  CREATE TABLE "footer_nav_columns_menus" (
  	"_order" integer NOT NULL,
  	"_parent_id" varchar NOT NULL,
  	"id" varchar PRIMARY KEY NOT NULL,
  	"title" varchar NOT NULL,
  	"variant" "enum_footer_nav_columns_menus_variant" DEFAULT 'primary' NOT NULL
  );
  ...
  ALTER TABLE "integrations" ADD CONSTRAINT "integrations_category_id_integration_categories_id_fk" FOREIGN KEY ("category_id") REFERENCES "public"."integration_categories"("id") ON DELETE set null ON UPDATE no action;
  ...
  ALTER TABLE "footer_nav_columns_menus_items" ADD CONSTRAINT "footer_nav_columns_menus_items_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."footer_nav_columns_menus"("id") ON DELETE cascade ON UPDATE no action;
  ALTER TABLE "footer_nav_columns_menus" ADD CONSTRAINT "footer_nav_columns_menus_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."footer_nav_columns"("id") ON DELETE cascade ON UPDATE no action;
  ...
  ALTER TABLE "footer_badges" ADD CONSTRAINT "footer_badges_logo_id_media_id_fk" FOREIGN KEY ("logo_id") REFERENCES "public"."media"("id") ON DELETE set null ON UPDATE no action;
  ...
  CREATE INDEX "footer_nav_columns_menus_items_order_idx" ON "footer_nav_columns_menus_items" USING btree ("_order");
  CREATE INDEX "footer_nav_columns_menus_items_parent_id_idx" ON "footer_nav_columns_menus_items" USING btree ("_parent_id");
  CREATE INDEX "footer_nav_columns_menus_order_idx" ON "footer_nav_columns_menus" USING btree ("_order");
  CREATE INDEX "footer_nav_columns_menus_parent_id_idx" ON "footer_nav_columns_menus" USING btree ("_parent_id");
  ...
  CREATE INDEX "footer_badges_logo_idx" ON "footer_badges" USING btree ("logo_id");
...
export async function down({ db, payload, req }: MigrateDownArgs): Promise<void> {
  ...
  DROP TABLE "footer_nav_columns_menus_items" CASCADE;
  DROP TABLE "footer_nav_columns_menus" CASCADE;
  ...
  DROP TYPE "public"."enum_footer_nav_columns_menus_items_link_type";
  DROP TYPE "public"."enum_footer_nav_columns_menus_variant";`)
}
