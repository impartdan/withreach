  ...
  return (
    <div className="container">
      ...
      {Array.isArray(cards) && cards.length > 0 && (
        <div
          className={`flex overflow-x-auto -mx-4 px-4 pb-2 scroll-smooth snap-x snap-mandatory [scrollbar-width:none] [&::-webkit-scrollbar]:hidden gap-6 md:overflow-x-visible md:mx-0 md:px-0 md:pb-0 md:grid ${
            cards.length === 1
              ? ''
              : cards.length === 2
                ? 'md:grid-cols-2'
